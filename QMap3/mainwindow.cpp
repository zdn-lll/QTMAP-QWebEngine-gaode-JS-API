...
void MainWindow::setPositionList(const QJsonObject &searchResult)
{
...
void MainWindow::on_setCityBt_clicked()
{
...
void MainWindow::on_startNavBt_clicked()
{
...
void MainWindow::on_setStartPostionBt_clicked()
{
    int selectedIndex = -1;
    startPoint = {-1.f, -1.f};
...
void MainWindow::on_setEndPostionBt_clicked()
{
    int selectedIndex = -1;
    endPoint = {-1.f, -1.f};
    QListWidgetItem* currentItem = ui->positionListWidget->currentItem();
